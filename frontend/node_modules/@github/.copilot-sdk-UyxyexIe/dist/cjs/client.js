...
`);
  ...
  setupLlmInference() {
    ...
    this.llmInferenceHandlers = {
      llmInference: (0, import_copilotRequestHandler.createCopilotRequestAdapter)(this.requestHandler, () => {
        if (!this.connection) {
          return void 0;
        }
        this._rpc ??= (0, import_rpc.createServerRpc)(this.connection);
...
stderr: ${stderrOutput}`
  ...
  attachConnectionHandlers() {
    ...
    (0, import_rpc.registerClientGlobalApiHandlers)(this.connection, this.llmInferenceHandlers);
