"""FastAPI entry point. All logic lives in the figma_to_react package."""
import json
...
from figma_to_react.agent.service import get_models, pipeline
from figma_to_react.sources.combined import load_combined
from figma_to_react.sources.figma_api import fetch_file, fetch_image_fills
from pathlib import Path

from figma_to_react.sources.figma_zip import extract_asset_files, extract_export_to_disk, parse_export
from figma_to_react.core.parser import parse_figma_key
from figma_to_react.api.projects import router as projects_router
