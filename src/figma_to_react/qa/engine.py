...
from figma_to_react.config import (MAX_VISUAL_REPAIR_SCREENS, PREVIEW_PORT, SSIM_REPAIR_THRESHOLD,
                     TEXT_REPAIR_THRESHOLD)
from figma_to_react.core.parser import collect_texts, norm
